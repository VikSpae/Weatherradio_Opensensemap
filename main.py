...
def getdata():
  ...
  if response_source.status_code == 200:
    ...
    if ((K2 / 10 - Tamb)) < 1:
      ...
      T67 = (K6 / 10) * np.sign(Tamb - K2 / 10) * (
          (np.log(abs(K2 / 10 - Tamb))) / np.log(10) + K7 / 100)
      print("Das ist T67 (2):", T67)

    print(T67)
    Td = Tobj - (K1 / 100) * (Tamb - K2 / 10) + (K3 / 100) * (math.exp(
        K4 / 1000 * Tamb)) * (K5 / 100) + T67
    ...
    print("Uhrzeit:", U)
    Tsky2 = Tmit * ((0.711 + 0.0056 * Tau + 0.000073 *
                     (Tau)**2 + 0.013 * math.cos(15 * U))**0.25)
    print("Sky2:", Tsky2)
